import styles from "./PrivacyPolitics.module.scss";
...
import PageBackArrowSVG from "../Page-Back-Arrow-SVG/PageBackArrowSVG.jsx";
...
function PrivacyPolitics() {
  ...
  const ScrollUpButtonClass = useSelector(
    state => state.reducer.ScrollUpButtonClass
  );
  const navigate = useNavigate();

  const [sizeArrow, setSizeArrow] = useState(iconSizes.Eighty);
  const [isFixedDisplay, setIsFixedDisplay] = useState(false);
  
  const blockScrollHandler = useCallback(() => {
	const element = backArrowWrapperElementRef.current;
	const topElementForClient = element.getBoundingClientRect().top;

	if (topElementForClient > 10) {
		setIsFixedDisplay(false);
		return;
	}
	if (topElementForClient <= 10) {
		setIsFixedDisplay(true);
	}
  }, [isFixedDisplay]);

  const backArrowWrapperElementRef = useRef(null);

  const pageBackLinkClickHandler = evt => {
    evt.preventDefault();
    navigate(-1);
  };
  ...
  useEffect(() => {
	if (ScrollUpButtonClass) {
        ScrollUpButtonClass.isPageEndVisibleScrollUpButton(true);
      }

	document.addEventListener('scroll', blockScrollHandler);

      return () => {
        if (ScrollUpButtonClass) {
          ScrollUpButtonClass.isPageEndVisibleScrollUpButton(false);
        }
		document.removeEventListener('scroll', blockScrollHandler);
      };
  }, [ScrollUpButtonClass, blockScrollHandler]);

  if (widthViewport < 690 && sizeArrow !== iconSizes.Fifty) {
    setSizeArrow(iconSizes.Fifty);
  }

  return (
    <div className={`${styles.privacy_politics_block}`}>
      <div className={`${styles.privacy_politics_wrapper} container_wrapper`}>
        <h1 className={`${styles.h1_heading}`}>
          Политика в отношении обработки персональных данных
        </h1>
        <div 
		  ref={backArrowWrapperElementRef}
		  className={`${styles.page_back_button_wrapper} ${isFixedDisplay && styles.back_arrow_fixed}`}>
          <div
            onClick={pageBackLinkClickHandler}
            className={`${styles.page_back_button}`}
          >
            <PageBackArrowSVG size={sizeArrow} />
            <p className={styles.page_back_button__description}>Назад</p>
          </div>
        </div>
        <div className={`${styles.privacy_politics_points}`}>
          <h2 className={styles.h2_heading}>1. Общие положения</h2>
          <p className={styles.description}>
            ...
            <b> Судаковой Анастасией Николаевной</b> (далее – Оператор).
          </p>
          <ul className={styles.point_description_list}>
            <li className={styles.point_description_item}>
            ...
            <li className={styles.point_description_item}>
              ...
              веб-сайта <b>httpsː//anastasiasudakova.ru</b>.
            </li>
          </ul>
          ...
          <ul className={styles.point_description_list}>
            ...
            <li className={styles.point_description_item}>
              ...
              <b> httpsː//anastasiasudakova.ru</b>.
            </li>
            <li className={styles.point_description_item}>
            ...
            <li className={styles.point_description_item}>
              2.14. <strong>Уничтожение персональных данных</strong> – любые
          ...
          <ul className={styles.point_description_list}>
            <li className={styles.point_description_item}>
              ...
              содержащие персональные данные;<br /> – в случае отзыва субъектом
              ...
              указанных в Законе о персональных данных;<br /> – самостоятельно
            ...
            <li className={styles.point_description_item}>
              3.2. Оператор обязан:<br /> – предоставлять субъекту персональных
              данных по его просьбе информацию, касающуюся обработки его
              персональных данных;<br /> – организовывать обработку персональных
              данных в порядке, установленном действующим законодательством РФ;<br />{" "}
              ...
              персональных данных;<br /> – сообщать в уполномоченный орган по
              ...
              запроса;<br /> – публиковать или иным образом обеспечивать
              неограниченный доступ к настоящей Политике в отношении обработки
              персональных данных;<br /> – принимать правовые, организационные и
              ...
              отношении персональных данных;<br /> – прекратить передачу
          ...
          <ul className={styles.point_description_list}>
            <li className={styles.point_description_item}>
              ...
              ее получения установлен Законом о персональных данных;<br /> –
              ...
              также принимать предусмотренные законом меры по защите своих прав;<br />{" "}
              ...
              услуг;<br /> – на отзыв согласия на обработку персональных данных;<br />{" "}
              ...
              или бездействие Оператора при обработке его персональных данных;<br />{" "}
          ...
          <ul className={styles.point_description_list}>
            <li className={styles.point_description_item}>
              5.1. <i>Фамилия, имя, отчество</i>.
            </li>
            <li className={styles.point_description_item}>
              5.2. <i>Электронный адрес</i>.
            </li>
            <li className={styles.point_description_item}>
              5.3. <i>Номера телефонов</i>.
            </li>
            <li className={styles.point_description_item}>
          ...
          <ul className={styles.point_description_list}>
            ...
            <li className={styles.point_description_item}>
              ...
              адрес электронной почты <b> anastasiyasudakova@yandex.ru</b> с
          ...
          <ul className={styles.point_description_list}>
            <li className={styles.point_description_item}>
              ...
              <i>
                ...
                с созданием сайтов, то здесь можно указать Федеральный закон "Об
                информации, информационных технологиях и о защите информации" от
                27.07.2006 N 149-ФЗ;
              </i>
              <br />
              – <i>уставные документы Оператора;</i>
            ...
            <li className={styles.point_description_item}>
              ...
              <b> httpsː//anastasiasudakova.ru</b> или направленные Оператору
          ...
          <ul className={styles.point_description_list}>
            ...
            <li className={styles.point_description_item}>
              ...
              Оператора <b> anastasiyasudakova@yandex.ru</b> с пометкой
            ...
            <li className={styles.point_description_item}>
              ...
              <b> anastasiyasudakova@yandex.ru</b> с пометкой «Отзыв согласия на
          ...
          <h2 className={styles.h2_heading}>14. Заключительные положения</h2>
          <ul className={styles.point_description_list}>
            <li className={styles.point_description_item}>
              ...
              <b> anastasiyasudakova@yandex.ru</b>.
            </li>
            <li className={styles.point_description_item}>
            ...
            <li className={styles.point_description_item}>
              ...
              сети Интернет по адресу <b>httpsː//anastasiasudakova.ru</b>.
            </li>
          </ul>
        </div>
      </div>
